...
void Hash_Cosine::Search_Cosine(std::string line,string &min_item,double &min_distance){
...
double Hash_Cosine::Cosine_distance(vector<int> y,vector<int> x,string &min_item,double &min_distance){
	long long int C_d = 0;
	long long int aa=0;
	long long int bb=0;
...
void Hash_Cosine::Calc_Cosine_distance(int buck ,vector<int> x,string &min_item,double &min_distance){
