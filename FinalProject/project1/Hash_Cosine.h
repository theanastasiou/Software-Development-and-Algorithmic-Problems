...
class Hash_Cosine{
	...
	public:
		...
		void Search_Cosine(std::string line,std::string &min_item,double &min_distance);
		double Cosine_distance(std::vector<int> y, std::vector<int> x,std::string &min_item,double &min_distance);
		void Calc_Cosine_distance(int buck,std::vector<int> x,std::string &min_item,double &min_distance);
